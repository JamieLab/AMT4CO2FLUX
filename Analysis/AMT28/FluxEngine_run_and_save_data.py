...
#MERGED Dataset
fl = run_fluxengine('FLUXENGINE_CONFIGS/SAT/MERGED_WANNINK2013_VT_COARE.conf') #24
flux_vt = np.concatenate((flux_vt,fl),axis=1)

fl = run_fluxengine('FLUXENGINE_CONFIGS/SAT/MERGED_WANNINK2013_VT_DON.conf') #25
flux_vt = np.concatenate((flux_vt,fl),axis=1)

fl = run_fluxengine('FLUXENGINE_CONFIGS/SAT/MERGED_WANNINK2013_VT_FIXED.conf') #26
flux_vt = np.concatenate((flux_vt,fl),axis=1)

#METOP=A Dataset
fl = run_fluxengine('FLUXENGINE_CONFIGS/SAT/METOPA_WANNINK2013_VT_COARE.conf') # 27
flux_vt = np.concatenate((flux_vt,fl),axis=1)

fl = run_fluxengine('FLUXENGINE_CONFIGS/SAT/METOPA_WANNINK2013_VT_DON.conf') # 28
flux_vt = np.concatenate((flux_vt,fl),axis=1)

fl = run_fluxengine('FLUXENGINE_CONFIGS/SAT/METOPA_WANNINK2013_VT_FIXED.conf')# 29
flux_vt = np.concatenate((flux_vt,fl),axis=1)

#S3A Dataset
fl = run_fluxengine('FLUXENGINE_CONFIGS/SAT/S3A_WANNINK2013_VT_COARE.conf')# 20
flux_vt = np.concatenate((flux_vt,fl),axis=1)

fl = run_fluxengine('FLUXENGINE_CONFIGS/SAT/S3A_WANNINK2013_VT_DON.conf')# 31
flux_vt = np.concatenate((flux_vt,fl),axis=1)

fl = run_fluxengine('FLUXENGINE_CONFIGS/SAT/S3A_WANNINK2013_VT_FIXED.conf')# 32
flux_vt = np.concatenate((flux_vt,fl),axis=1)

#S3AB Dataset
fl = run_fluxengine('FLUXENGINE_CONFIGS/SAT/S3AB_WANNINK2013_VT_COARE.conf')#33
flux_vt = np.concatenate((flux_vt,fl),axis=1)

fl = run_fluxengine('FLUXENGINE_CONFIGS/SAT/S3AB_WANNINK2013_VT_DON.conf')#34
flux_vt = np.concatenate((flux_vt,fl),axis=1)

fl = run_fluxengine('FLUXENGINE_CONFIGS/SAT/S3AB_WANNINK2013_VT_FIXED.conf')#35
flux_vt = np.concatenate((flux_vt,fl),axis=1)
